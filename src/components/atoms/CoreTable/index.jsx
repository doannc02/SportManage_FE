...
const ExpandableRow = ({ row, columns, index, totalRows, onRowClick }) => {
    ...
    return (
        <>
                ...
                {_.map(columns, (column, indexColumn) => {
                    return (
                        <TableCell
                            ...
                            key={indexColumn}
                            style={{
                                borderBottom: index !== totalRows - 1 || open ? '1px solid rgba(224, 224, 224, 1)' : '',
                            }}
                        >
                            <CellContent
                                row={row}
            ...
            {row.description && (
                <TableRow>
                    <TableCell style={{ paddingBottom: 0, paddingTop: 0, border: 0 }} colSpan={columns.length + 1}>
            ...
            >
                ...
                >
                    {tableHead || (
                        <TableHeadCommon>
                            <TableRow>
                                ...
                                {hasDescriptions && <TableCell style={{ width: '48px', backgroundColor: '#f0f3f7' }} />}
                    ...
                    <TableBody>
                        {isLoading && (
                            <TableRowLoading
                                colSpan={hasDescriptions ? columnsChecked.length + 1 : columnsChecked.length}
                            />
                        )}
