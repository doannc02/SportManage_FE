...
import useListOrders from "./useListOrder"
                    ...
                    <ModalBody>
                        <Alert status="error" borderRadius="md" mb={4}>
                            ...
                            <Text fontWeight="bold" color="red.500">
                                Cảnh báo: Khi xóa, bạn sẽ không thể khôi phục sản phẩm và tất cả các biến thể đi kèm!
                            </Text>
                        </Alert>
                        <Text>Bạn có chắc chắn muốn xoá sản phẩm <strong>{selectedProductName}</strong> này không?</Text>
                    </ModalBody>
