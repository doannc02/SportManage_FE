...
const ProductDetailAdmin = () => {
    const [
        ...
        { append, onSubmit, appendProdCategory, watch, setValue, removeProdCategory }
    ] = useDetailProduct()
            ...
            <form onSubmit={onSubmit}>
                <Grid templateColumns="repeat(12, 1fr)" gap={4} mb={6}>
                    ...
                    <GridItem colSpan={[6, 6, 3]}>
                        <Box display="flex" alignItems="flex-end" gap={2}>
                            <Box flex={1}>
                                <CoreAutoComplete
                                    ...
                                    required
                                    rules={{ required: fieldProductCategories.length > 0 ? null : "Trường này là bắt buộc!" }}
                                    control={methodForm.control}
                                    name="categoryIds"
                                    multiple
                        ...
                        {!id ? (fieldProductCategories ?? []).length > 0 && (
                            <Box mt={4}>
                                <Box fontWeight="medium" mb={2}>Danh mục đã thêm:</Box>
                                <Box display="flex" flexDirection="column" gap={2}>
                                    {(fieldProductCategories ?? []).map((item, idx) => (
                                        ...
                                        >
                                            <Box>
                                                <Box fontWeight="semibold">{item.category.name}</Box>
                    ...
                    <GridItem colSpan={12} mt={6}>
                        <Box display="flex" justifyContent="center">
                            <Button loading={isLoadingSubmit} colorScheme="teal" size="lg" type="submit">
                                Lưu sản phẩm
                            </Button>
                        </Box>
                    </GridItem>
